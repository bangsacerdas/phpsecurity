...
// *** Predictable Resource Vulnerability: you should remove the "docs", "extras" and "examples" folders!
// ***                                     these could provide attackers with a "back door" allowing them to send
// ***                                     SPAM emails using your website as a host
